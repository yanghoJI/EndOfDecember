...
class Net(nn.Module):
    ...
    def __init__(self, outsize):
        ...
        self.conv2x = nn.Conv2d(1, 20, kernel_size=2, padding=0)     #out 10,3,3
        self.conv3x = nn.Conv2d(1, 20, kernel_size=3, padding=0)     # out 10,2,2
        self.conv4x = nn.Conv2d(1, 20, kernel_size=4, padding=0)  # out 10,1,1


        self.fc1 = nn.Linear(90*2 + 40*2 + 10*2, outsize)
...
def plotdata(epi, score, max_prob):
    ...
    plt.savefig('TrainGraph2048#1.png', dpi=300)
    plt.close()
